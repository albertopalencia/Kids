  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 5) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Exito!</h4>
                Clave de usuario cambiada correctamente.
                Tendra que volver a iniciar sesion.
            </div>";

          echo "<meta http-equiv='refresh' content='5; url=index.php?alert=2'>";
    }
    ...
    ?>
      ...
      <div class="box box-primary">
        ...
        <form role="form" class="form-horizontal" method="POST"
         action="?module=form_profile" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <?php
              if ($data['foto']=="") { ?>
                <img style="border:1px solid #eaeaea;border-radius:50px;"
              ...
              <label style="font-size:25px;margin-top:10px;" class="col-sm-8">
                <?php echo $data['nombres'].' '.$data['apellidos']; ?></label>
            </div>
            <hr>
            <div class="form-group">
              <label class="col-sm-2 control-label">Nombre de Usuario</label>
              <label style="text-align:left" class="col-sm-8 control-label">
                 <?php echo $data['username']; ?></label>
            </div>
            ...
            <div class="form-group">
              <label class="col-sm-2 control-label">Estado</label>
               ...
               <?php  if($data['estado'] == '1'){
                 ...
                 echo "<span class='btn btn-warning btn-sm'>
